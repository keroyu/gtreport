...
<div class="input-box" id="inputPanel">
	<span><span class="option">專題名稱：</span><select name="pjSN" id="pjSN" class="md"><?php echo $selectPj; ?></select>*<a href="/projects">新增專題</a></span>
	...
	<span><span class="option">負責人：</span><input type="text" class="lg" name="designer" id="designer">*<div class="name-box" id="nameBox"><ul><li>Sam</li><li>Mori</li><li>阿堡</li><li>姐姐</li><li>Kero</li><li>虎牙</li><li>阿泰</li><li>小瑜</li><li>屁屁</li><li>Sai</li><li>阿港</li><li>阿男</li><li>Jimi</li><li>Claire</li></ul></div></span>
