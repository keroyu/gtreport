...
<div class="input-box" id="inputPanel">
	...
	<span><span class="option">專案類型：</span><input type="radio" name="type" id="type" value="W" checked> 網頁 <input type="radio" name="type" id="type" value="P"> 平面 <input type="radio" name="type" id="type" value="M"> 多媒體 *</span>
...
<div class="text-center margin-tb"><a class="btn info lg"  href="" target="_blank">查看列印版</a></div>
